    ...
    >
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          {/* Right side buttons container for side-by-side alignment */}
          <div className="flex items-center space-x-2 order-3 md:order-none">
            {!isLoggedIn ? (
              <Link to="/login">
                <button
                  type="button"
                  className="card-nav-cta-button hidden md:inline-flex border-0 rounded-xl px-4 py-[7px] items-center h-full font-medium cursor-pointer transition-colors duration-300"
                  style={{
